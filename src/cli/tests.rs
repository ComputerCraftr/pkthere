...
#[test]
fn icmp_session_pool_defaults_to_four_ready_reserves() {
    assert_eq!(crate::cli::DEFAULT_ICMP_SESSION_POOL_SIZE, 4);
    assert_eq!(crate::cli::MAX_ICMP_SESSION_POOL_SIZE, 32);
}
